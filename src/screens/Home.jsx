...
const transactions = [
  { id: 1, name: 'Morning Coffee', category: 'Food', amount: -5.5, date: 'Today', icon: Coffee, color: colors.amber },
  { id: 2, name: 'Grocery Store', category: 'Shopping', amount: -82.3, date: 'Yesterday', icon: ShoppingBag, color: colors.purple },
  { id: 3, name: 'Uber Ride', category: 'Transport', amount: -24.0, date: 'Yesterday', icon: Car, color: colors.blue },
  { id: 4, name: 'Electric Bill', category: 'Bills', amount: -145.0, date: '2 days ago', icon: Home, color: colors.red },
  { id: 5, name: 'Salary Deposit', category: 'Income', amount: 4500.0, date: '3 days ago', icon: Wallet, color: colors.green },
];
    ...
    <View style={custom.container}>
      ...
      >
          ...
          <View style={custom.balanceChangeRow}>
            <View style={custom.balanceBadge}>
              <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                ...
                <Text style={[custom.balanceBadgeText, { marginLeft: 3 }]}>+8.2%</Text>
              </View>
            </View>
        ...
        <View style={{ flexDirection: 'row', gap: 12, marginBottom: 24 }}>
          <View style={[custom.ieCard, { backgroundColor: colors.greenLight }]}>
            <View style={[custom.ieIconWrap, { backgroundColor: '#FFFFFF' }]}>
              <ArrowUpRight size={20} color={colors.green} strokeWidth={2.5} />
            </View>
            <View>
              <Text style={custom.ieLabel}>Income</Text>
              <Text style={[custom.ieAmount, { color: colors.greenDark }]}>$4,500</Text>
            </View>
          </View>

          <View style={[custom.ieCard, { backgroundColor: colors.redLight }]}>
            <View style={[custom.ieIconWrap, { backgroundColor: '#FFFFFF' }]}>
              <ArrowDownRight size={20} color={colors.red} strokeWidth={2.5} />
            </View>
            <View>
              <Text style={custom.ieLabel}>Expenses</Text>
              <Text style={[custom.ieAmount, { color: colors.redDark }]}>$2,850</Text>
            </View>
          </View>
        </View>
        ...
        <View style={custom.card}>
          {transactions.map((tx, index) => (
            <View key={tx.id}>
              ...
              {index < transactions.length - 1 && <View style={custom.txDivider} />}
            </View>
          ))}
        </View>
      </ScrollView>
